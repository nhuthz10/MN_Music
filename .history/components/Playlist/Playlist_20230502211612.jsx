    ...
    <ScrollView style={styles.listSong}>
      ...
      <View style={styles.listSongContent}>
        ...
        <View style={styles.listSongContentList}>
          <View style={styles.listSongContentListHeading}>
            <Text style={styles.listSongContentListHeading__title}>Title</Text>
            <Text style={styles.listSongContentListHeading__title}>Artist</Text>
            <Text style={styles.listSongContentListHeading__title}>
              Duration
            </Text>
          </View>
