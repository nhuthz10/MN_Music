...
import MNChart from '../../MNChart/MNChart';
  ...
  useEffect(() => {
    async function loadContent() {
      ...
      const response = await fetch(
        'https://api-music-nine.vercel.app/api/charthome',
        //`https://cors-api-zingmp3.vercel.app/api/charthome`,
        //`https://apizingmp3.vercel.app/api/charthome`,
      );
      const {data} = await response.json();
      let listIdSong;
      if (data) {
        listIdSong = data.RTChart.items.reduce((acc, song) => {
  ...
  return (
    ...
    <SafeAreaView style={{flex: 1}}>
      ...
      <ScrollView
        ...
        <Text style={styles.chart}>#MNchart</Text>

        <MNChart dataChart={fullData.RTChart} />
